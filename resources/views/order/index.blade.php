        ...
        <div class="w-full max-w-4xl p-4">
            <x-slot name="header">
                <div class="flex justify-between">
                    ...
                    <div>
                        <a href="{{ route('orders.create') }}" class="ml-4 inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 active:bg-indigo-700 focus:outline-none focus:border-indigo-700 focus:ring focus:ring-indigo-200 disabled:opacity-25 transition ease-in-out duration-150">
                            Crée une commande
                        </a>
                    </div>
                </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('order.show', $order) }}" class="text-blue-600 hover:text-blue-900 mr-2">
                                Détails
                            </a>
                            <a href="{{ route('order.edit', $order->order_id) }}" class="text-indigo-600 hover:text-indigo-900 mr-2">
                                Modifier
                            </a>
